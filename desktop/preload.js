...
contextBridge.exposeInMainWorld('desktopWindow', {
  ...
  zoomIn: () => ipcRenderer.invoke('desktop-window-zoom-in'),
  zoomOut: () => ipcRenderer.invoke('desktop-window-zoom-out'),
  zoomReset: () => ipcRenderer.invoke('desktop-window-zoom-reset'),
  ...
  kugouProxySearch: (keywords, limit) => ipcRenderer.invoke('kugou-proxy-search', String(keywords || ''), Number(limit) || 20),
  kugouProxyUserPlaylists: () => ipcRenderer.invoke('kugou-proxy-user-playlists'),
  kugouProxyPlaylistTracks: (playlistId) => ipcRenderer.invoke('kugou-proxy-playlist-tracks', String(playlistId || '')),
