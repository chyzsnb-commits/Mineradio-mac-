...
const desktopWindowApi = {
  ...
  wallpaperLibraryScanDir: (dirPath) => ipcRenderer.invoke('mineradio-wallpaper-library-scan-dir', String(dirPath || '')),
  wallpaperLibraryScanHttp: (baseUrl) => ipcRenderer.invoke('mineradio-wallpaper-library-scan-http', String(baseUrl || '')),
  wallpaperLibraryList: () => ipcRenderer.invoke('mineradio-wallpaper-library-list'),
  wallpaperLibraryMedia: (recordId, kind) => ipcRenderer.invoke('mineradio-wallpaper-library-media', String(recordId || ''), String(kind || '')),
