...
- **当前 Codex 任务链**：PR #27（显卡模式与快速启动）→ PR #29（Mac 真实显卡占用）→ PR #30（主循环真正休眠）均为叠加关系；当前分支 `codex/singing-mode-power-save` 基于 #30，功能存档 `43582f6`、审查修复存档 `4b87482`，实现唱歌模式按需计算与麦克风省电，待创建叠加 PR。
...
- 分支：`codex/singing-mode-power-save`；基于 PR #30；设计 commit（代码存档点）`000a7a8`，功能 commit `43582f6`，审查修复 commit `4b87482`。
