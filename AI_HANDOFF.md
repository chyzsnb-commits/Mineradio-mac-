...
- **当前 Codex 任务链**：PR #27（显卡模式与快速启动）→ PR #29（Mac 真实显卡占用）→ PR #30（主循环真正休眠）→ PR #31（唱歌模式省电）均为叠加关系；PR #31 分支 `codex/singing-mode-power-save` 基于 #30，功能存档 `43582f6`、审查修复存档 `4b87482`，实现唱歌模式按需计算与麦克风省电。
