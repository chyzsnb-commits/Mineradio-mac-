...
- 验证：新增 3 项后处理测试，雨境相关共 8 项通过；`npm run check` **173/173**；Electron 本地启动成功，页面 Console 0 errors（保留 1 条既有 warning）。
...
- [x] **雨境玻璃水珠迁移**：独立 RG Metaball 后处理已接入预设 9；新增开关、数量、流速、尺寸控件和独立持久化；`npm run check` 173/173。
