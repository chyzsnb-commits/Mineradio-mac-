...
- [ ] **x64 CI 验证**：已把下线的 macos-13 改为 macos-15-intel，等待当前 PR 在线构建最终确认。
...
- 分支：`codex/fix-x64-ci-runner`；基于 PR #44。
...
- 未验证：等待 GitHub 为当前分支实际分配两个架构的运行器并完成在线构建。
