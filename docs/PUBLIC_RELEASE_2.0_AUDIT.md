...
- 本机 `/Applications/Mineradio.app` 已替换为 arm64 2.0.0；其 `app.asar` 与构建目录、挂载后的 arm64 DMG 三方 SHA-256 均为 `75658b20f8b9ccfd1ee193a399375e150dc4920aaf0a1063c7fce981176839e2`。另外两个被系统识别的构建副本已移入 `.noindex` 备份并取消 `.app` 后缀。

已验证候选产物：

| 架构 | 文件名 | SHA-256 |
|---|---|---|
| Apple Silicon | `Mineradio-2.0.0-arm64.dmg` | `4585bb944fb8a303e5c43b8e7277832480f880e2c57eb4420d97977f4ef21199` |
| Intel | `Mineradio-2.0.0-x64.dmg` | `52de9ccfc45193e3149c0fa43c88c7bbcf24283999c3bdf9c5705c373fef6525` |
