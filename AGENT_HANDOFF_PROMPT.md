...
- 本地服务默认只听 127.0.0.1
- 不要重新引入汽水
- **水膜共振：先不要。** 已从 2.0 撤下；用户明确搁置，未经用户点名不要恢复、不要打磨、不要列为下一步
- 不要启用自动更新
...
2) ee328b0 Beat 融合 + 2.0 发布候选
   ...
   - 删汽水与水膜（水膜后续仍先不要）；修 QQ「我喜欢」对象键解析（22/22）
...
10. **水膜共振先不要**——不恢复、不打磨、不排期，除非用户当场点名
11. 完成后更新 AI_HANDOFF.md；能写 Obsidian 进度再写
