...
var presetDisplayOrder = [0, 10, 9, 11, 6, 5, 4, 2, 1, 3, 7, 8, 12, 13];   // 9=雨境;11=云瀑共振;12=声波地形;13=声波工坊
...
function normalizeFxArchiveSnapshot(raw) {
  ...
  return {
    ...
    playlistPanelOpenDuration: archiveNumber(raw, 'playlistPanelOpenDuration', fxDefaults.playlistPanelOpenDuration, 0.12, 0.90),
    playlistPanelCloseDuration: archiveNumber(raw, 'playlistPanelCloseDuration', fxDefaults.playlistPanelCloseDuration, 0.08, 0.72),
