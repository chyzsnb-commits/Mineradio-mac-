...
function updateDesktopRuntimeState(state) {
  ...
  if (!isDeepBackgroundMode() && typeof refreshPeekPanelsAfterResume === 'function') refreshPeekPanelsAfterResume();
...
function installRenderPowerHooks() {
  ...
  document.addEventListener('visibilitychange', function () {
    ...
    if (!isDeepBackgroundMode()) {
      ...
      if (typeof refreshPeekPanelsAfterResume === 'function') refreshPeekPanelsAfterResume();
    }
  });
  window.addEventListener('focus', function () {
    ...
    applyRendererPowerMode();
    if (!isDeepBackgroundMode()) {
      recoverVisualsAfterBackground('focus');
      if (typeof refreshPeekPanelsAfterResume === 'function') refreshPeekPanelsAfterResume();
    }
  });
